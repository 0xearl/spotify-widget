...
class Player extends React.Component {
    ...
    render() {
        return (
            <div className="flex w-[600px] items-center justify-center bg-slate-700">
                <div className="h-full">
                    <img width="250" height="250" src={this.state.songImage}/>
                </div>
                <div className="w-full ml-4 col-span-2">
